  ...
  <section class="container">
      <div class="card_1">
                            ...
                            <v-layout justify-space-between pa-3>
                                ...
                                <v-scroll-y-transition mode="out-in">
                                    ...
                                    <v-card-text>
                                        ...
                                        <div class="blue--text subheading font-weight-bold">s name</div>
                                    </v-card-text>
                                    <v-divider></v-divider>
        ...
        <WorkForceCalender></WorkForceCalender>
          ...
          <button @click="flip()" style="" class="front_btn">flip</button>
