...
var WorkForcesWorkingDetailsUpdateByDate = {
    ...
    workforcesCalenderWorkingDetailsUpdateById: function (idClientAndHours, callback) {
        ...
        return db.query("UPDATE workforces_working_details as wwd JOIN clients_workforces as cw on (wwd.client_workforce_id=cw.client_workforce_id) set work_hours=? ,work_date=? WHERE workforce_work_id=?", [idClientAndHours.work_hours, idClientAndHours.work_date, idClientAndHours.workforce_id], callback);
    }
};
