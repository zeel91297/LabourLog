<template>
  <div>
    ...
    <v-container grid-list-md grid-list-sm>
      <v-layout row wrap class="container_height">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js" scoped></script>

<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" scoped></script>
